...
INSERT INTO Jugadores(Id, username, psswrd, age, scores) VALUES(2,'Maria', 'pass2', 15, 5678);
INSERT INTO Jugadores(Id, username, psswrd, age, scores) VALUES(3,'Pedro', 'pass3', 3, 9012);
INSERT INTO Jugadores(Id, username, psswrd, age, scores) VALUES(4,'Luis', 'pass4', 4, 3456);
INSERT INTO Jugadores(Id, username, psswrd, age, scores) VALUES(5,'Julia', 'pass5', 5, 7890);

INSERT INTO Partidas(Id, Ciudad, fecha, hora, minutes, winner) VALUES(1,'Barcelona', 20200320, 1416, 11.03, 1);
INSERT INTO Partidas(Id, Ciudad, fecha, hora, minutes, winner) VALUES(2,'Madrid', 20200319, 1630, 15.4, 4);
INSERT INTO Partidas(Id, Ciudad, fecha, hora, minutes, winner) VALUES(3,'Sevilla', 10100318, 1320, 14.7, 2);
